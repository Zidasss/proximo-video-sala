...
export default function Home() {
  ...
  const [quality, setQuality] = useState<Quality>("1080"), [devices, setDevices] = useState<MediaDeviceInfo[]>([]), [deviceId, setDeviceId] = useState(""), [vertical, setVertical] = useState(false), [notice, setNotice] = useState("");
